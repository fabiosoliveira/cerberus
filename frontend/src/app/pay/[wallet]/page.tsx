...
export default function Pay() {
  ...
  const wallet: string =
    typeof params.wallet === "string" ? params.wallet : params.wallet[0];
  ...
  function btnPayClick() {
    setMessage(
      "Please, authorize our recurring charges (monthly, 1 year authorization). Cancel anytime."
    );

    startPayment(plan)
      .then((result) => {
        setMessage(
          "Payment authorized. Starting the 1st month charge...wait..."
        );
        return payUser();
      })
