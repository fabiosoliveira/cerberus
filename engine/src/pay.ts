    ...
    try {
      ...
      await sendMail(
        ...
        `
                ...
                Your account was blocked due to insufficient balance or allowance. Please, click in the link below (or copy-paste in the browser) to update your payment info:
